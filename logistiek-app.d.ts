declare namespace OpenIDConnect {
  declare type GrantTypes = 'authorization_code' | 'refresh_token' | 'client_credentials' | string
  ...
  declare type PromptValues = 'none' | 'login' | 'consent' | 'select_account' | string
  declare type ResponseTypes = 'code' | 'id_token' | 'refresh_token' | string
  declare type TokenEndpointAuthMethods = 'client_secret_basic' | 'client_secret_post' | 'none' | string
